...
SECTION_EXPECTATIONS: dict[str, dict] = {
    # must_not_contain_any: use terms that only appear in WRONG content (regulation text,
    # penalty table rows). Do NOT include "infringement fee" - it appears in legitimate
    # RTA section text as "infringement fee specified in Schedule 1B". Use "Schedule 1A "
    # (with trailing space) not "Schedule 1A" to avoid substring-matching "Schedule 1AA".
    "NZLEG/RTA/s13A": {
